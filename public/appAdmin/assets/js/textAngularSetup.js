...
.value('taOptions',  {
	...
	keyMappings : [],
	toolbar: [
		['h1', 'h2', 'p', 'pre', 'quote','bold', 'italics', 'underline', 'strikeThrough', 'redo', 'undo'],//'clear','ul', 'ol','h3', 'h4', 'h5', 'h6'
		['justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'indent', 'outdent', 'html', 'insertImage', 'insertLink']// 'wordcount', 'charcount','insertVideo'
	],
	classes: {
		focussed: "focussed",
		toolbar: "btn-toolbar",
		toolbarGroup: "btn-group",
		toolbarButton: "btn btn-white",
